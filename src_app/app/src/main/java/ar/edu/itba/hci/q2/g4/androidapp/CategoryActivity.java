...
public class CategoryActivity extends NavigationDrawerActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Log.d("CATEGORY", "toolbarTitle: " + toolbarTitle);
			...
			thread = new AsyncTaskWithContext<Void, Void, Void>() {
				...
				protected Void doInBackground(Void... params) {
					try {
						...
						String genre = getIntent().getStringExtra(TAG_GENRE);
...
//								p, ServiceHandler.GET);
						...
						Product.getAllProductsByType(matched, newList, offerList, filters, getResources());

						categories = Category.getCategories(filters);
